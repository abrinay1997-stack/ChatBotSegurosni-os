...
const Schema = z.object({
  ...
  LLM_PROVIDER: z.enum(["groq", "glm", "nvidia"]).default("groq"),
  LLM_FALLBACK_PROVIDER: z.enum(["groq", "glm", "nvidia"]).optional(),
...
export function parseConfig(env: NodeJS.ProcessEnv): Config {
  ...
  return {
    ...
    llmFallbackProvider: p.LLM_FALLBACK_PROVIDER,
    groqApiKey: p.GROQ_API_KEY,
    glmApiKey: p.GLM_API_KEY,
    nvidiaApiKey: p.NVIDIA_API_KEY,
    nvidiaModel: p.NVIDIA_MODEL,
